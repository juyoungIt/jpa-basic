...
@SpringBootTest
@EntityScan(basePackages = {"com.howard.jpabasic.section7.section7_1.single_table"})
public class Section7Test {
    ...
    @Test
    @DisplayName("InheritanceType.SINGLE_TABLE - SINGLE_TABLE 전략으로 상속관계를 표현하는 테이블을 생성한다.")
