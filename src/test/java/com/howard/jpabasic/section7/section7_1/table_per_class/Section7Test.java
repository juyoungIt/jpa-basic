...
@SpringBootTest
@EntityScan(basePackages = {"com.howard.jpabasic.section7.section7_1.table_per_class"})
public class Section7Test {
    ...
    @Test
    @DisplayName("InheritanceType.TABLE_PER_CLASS - TABLE_PER_CLASS 전략으로 상속관계를 표현하는 테이블을 생성한다.")
    public void inheritanceTypeSingleTableTest() {
        try {
            etx.begin();
